...
public class TrxData extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            // Execute SQL queries
            try (PreparedStatement maxStmt = conn.prepareStatement("SELECT MAX(TotalAmount) FROM tdtldb.bills");
                 PreparedStatement countStmt = conn.prepareStatement("SELECT COUNT(*) FROM tdtldb.bills");
                 PreparedStatement avgStmt = conn.prepareStatement("SELECT AVG(TotalAmount) FROM tdtldb.bills")) {
