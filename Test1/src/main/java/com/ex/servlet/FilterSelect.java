    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (filterIdsNode != null && filterIdsNode.isArray()) {
            ...
            try {
                ...
                try (PreparedStatement resetStmt = conn.prepareStatement("UPDATE tdtldb.filters SET status = 0")) {
                ...
                if (filterIds.length > 0) {
                    ...
                    String updateQuery = "UPDATE tdtldb.filters SET status = 1 WHERE filter_id = ?";
